...
# at the end is the prompting script:
...
while True:
    ...
    # Make sure your max tokens are less than or equal to block size or you will get errors else 
    # you can just crop it as done above....